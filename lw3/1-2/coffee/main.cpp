...
//		auto latte = make_unique<CStandartLatte>();
//		// добавляем корицы
...
//							make_unique<CDoubleLatte>()),	// | | |   в самом сердце - Латте
//						2),							// | | 2 дольки лимона
...
//	{
//		auto beverage = 
//			make_unique<CRedTea>()							// Наливаем чашечку ного чая,
