...
Подумайте, как можно реализовать возможность создавать копию класса `Picture`? Копия картины содержит копию фигур. Модификация копии картины не оказывает влияния на оригинал и наоборот.
