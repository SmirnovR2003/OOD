...
#pragma once
class ModernGraphicsLibObjectAdapter : 
	public graphics_lib::ICanvas
{
public:
	ModernGraphicsLibObjectAdapter(modern_graphics_lib::CModernGraphicsRenderer& modernLib)
		: m_rgbColor(0, 0, 0, 1)
	...
	~ModernGraphicsLibObjectAdapter()
	{
	}
private:
